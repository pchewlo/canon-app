...
export function PowerWinAppendix({ config }: { config: OperatorConfig }) {
  ...
  return (
    <Section id="methodology" eyebrow="01 · Methodology" title="How we measure lift.">
      ...
      <Body>
        ...
        conservative to account for real-world clustering in player
        outcomes. We&apos;ll re-run the planner with your real data
        before the pilot kicks off, since timing ultimately depends on
        your bonus distribution and the variance of the ROI curve.
      </Body>
  ...
  return (
    ...
    >
      ...
      <Body>
        ...
        Power.Win. Default is a WebSocket stream for real-time signals
        paired with direct API for everything else. In the planning phase
        we&apos;d need to understand your current stack and how we
        actually issue the bonus triggers.
      </Body>
    </Section>
  )
}
    ...
    >
      ...
      <UnorderedList
        items={[
          ...
          "We will run daily stand-ups, Power.Win can drop in when it suits",
          "Weekly sprint review. Once a week we walk through progress, the devs give their update, and we agree the next week's priorities together. This will require Power.Win.",
        ]}
      />
    </Section>
  )

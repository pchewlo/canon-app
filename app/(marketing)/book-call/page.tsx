      ...
      <div className="mx-auto max-w-6xl px-6 pt-20 pb-24 lg:pt-28 lg:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5">
            ...
            <h1
              className="mt-4 text-balance font-semibold leading-[1.05] tracking-[-0.028em] text-canon-ink"
              style={{ fontSize: "clamp(40px, 5vw, 56px)", maxWidth: "20ch" }}
            >
              Tell us what you want to lift.
            </h1>
            <p className="mt-6 max-w-md text-[16px] leading-[1.55] text-quest-ink-muted">
              30 minutes on your bonus spend, your retention curves, and what
              Canon would do differently. Run on your data or ours.
            </p>

            <div className="mt-10 border-t border-canon-line pt-8">
              <div className="font-mono text-[11px] font-medium uppercase tracking-[0.14em] text-quest-ink-faint">
                What to expect
              </div>
...
function Step({
  ...
  return (
    <li className="flex items-start gap-4">
      <span className="font-mono text-[11px] font-semibold tracking-[0.14em] text-canon-green tabular-nums pt-0.5">
        {n}
      </span>
      <div>
        <div className="text-[14px] font-semibold tracking-[-0.005em] text-canon-ink">
          {title}
        </div>
